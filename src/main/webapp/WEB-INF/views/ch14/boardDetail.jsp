	...
	<div class="card-body">
		<div>
		   <div>
		      ...
		      <a class="btn btn-info" href="boardList">목록</a>
		      <a class="btn btn-info" href="boardUpdateForm?bno=${board.bno}">수정</a>
		      <a class="btn btn-info" href="boardDelete?bno=${board.bno}">삭제</a>
