...
<div class="card m-2">
	...
	<div class="card-body">
		<div class="card m-2">
			...
			<div class="card-body">
				<form id="form0" name="form2" method="POST" action="method1" onsubmit="checkData(this)">
	                 ...
	                 <div class="input-group">
	                    <div class="input-group-prepend"><span class="input-group-text">전화번호</span></div>
			...
			<script>
				function checkData(form) {
					...
					if(param2 === "") {
						...
						if(result === false) {
							param2Error.innerHTML = "전화번호 형식이 틀렸습니다.";
							checkResult = false;
						}
					}
					...
					if(param3 === "") {
						...
						if(result === false) {
							param3Error.innerHTML = "이메일 형식이 틀렸습니다.";
							checkResult = false;
						}
					}
		...
		<div class="card m-2">
			...
			<div class="card-body">
				<form id="form1" name="form3">
	                 <div class="input-group">
	                    <div class="input-group-prepend"><span class="input-group-text">주민번호</span></div>
			...
			<script>				
				function requestPost() {
					const param1 = $("#param1").val(); // 주민번호: xxxxxx-[1234]xxxxxx
					...
					if(param1 === "") {
						...
						// 주민번호앞자리:  97/ 월 0:0~9, 1:0~2 / 일 0:1~9, 1-2:0~9, 3:30,31 / [-] / 뒷자리: 1-4 + 0~9 6자리  
						const pattern = /^\d{2}([0]\d|[1][0-2])([0][1-9]|[1-2]\d|[3][0-1])[-]*[1-4]\d{6}$/;
						const result = pattern.test(param1);
						if(result === false) {
							param1Error.html("주민번호 형식이 틀렸습니다.");
							checkData = false;
						}
					}
